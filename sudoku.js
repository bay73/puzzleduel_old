...
sudoku.showRules = function(){
   sudoku.headerPanel.html('Ваша задача - заполнить сетку цифрами от 1 до 9 так, чтобы цфиры в столбцах, строках и выделенных квадратах 3x3 не повторялись. Часть цифр уже расставлена. '+
      'Ваш соперник решает точно такую же задачу. Клетка закрашивается зеленым, если вы поставили ы нее цифру раньше соперника и красным - в противном случае. <br>' +
      'Для решения задачи наведите прицел на требуемую клетку и нажмите клавишу с цифрой, которую хотите вставить.')
}
