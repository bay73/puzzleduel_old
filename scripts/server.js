...
var bots = [
   ...
   {name: 'Wart', delay: 450, type: BaySudokuBot, hours: [{min: 16, max: 24}, {min: 0, max: 8}]},
   {name: 'Crazy', delay: 330, type: BaySmartBot, hours: [{min: 12, max: 24}, {min: 0, max: 4}]},
   {name: 'Okazaki', delay: 350, type: BaySmartBot, hours: [{min: 0, max: 16}]},
   {name: 'Yoko Tokawa', delay: 400, type: BaySmartBot, hours: [{min: 0, max: 16}]},
   {name: 'Martin J.', delay: 420, type: BaySmartBot, hours: [{min: 8, max: 24}]},
   {name: 'Matej Balenovic', delay: 450, type: BaySmartBot, hours: [{min: 4, max: 20}]},
   {name: 'Radik', delay: 500, type: BaySmartBot, hours: [{min: 20, max: 24}, {min: 0, max: 12}]},
   {name: 'Hua Qiang', delay: 520, type: BaySmartBot, hours: [{min: 0, max: 16}]},
   {name: 'Hamersley', delay: 550, type: BaySmartBot, hours: [{min: 12, max: 24}, {min: 0, max: 4}]},
   {name: 'Игорь Веселов', delay: 580, type: BaySmartBot, hours: [{min: 4, max: 20}]},
   {name: 'Curt McKnight', delay: 600, type: BaySmartBot, hours: [{min: 8, max: 24}]},
   {name: 'Aragorn', delay: 620, type: BaySmartBot, hours: [{min: 4, max: 20}]},
   {name: 'Masha Marinovic', delay: 650, type: BaySmartBot, hours: [{min: 16, max: 24}, {min: 0, max: 8}]},
   {name: 'Lénárd', delay: 680, type: BaySmartBot, hours: [{min: 8, max: 24}]},
   {name: 'Maïténa', delay: 700, type: BaySmartBot, hours: [{min: 16, max: 24}, {min: 0, max: 8}]},
   {name: 'Claude Houdin', delay: 720, type: BaySmartBot, hours: [{min: 20, max: 24}, {min: 0, max: 12}]},
];
