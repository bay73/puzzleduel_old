...
var BayPuzzle = function(properties){
  ...
  this.invitation = properties.invitation;
  var self = this;
...
BayPuzzle.prototype.connect = function(invitation) {
  this.socket.emit('choose',{game: 'sudoku', size:this.size, name: this.name, invitation: invitation});
  this.changeState('connecting');
};
